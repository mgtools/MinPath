...
#define lpx_check_name        glp_lpx_check_name         /* obsolete */
#define lpx_set_obj_c0        glp_lpx_set_obj_c0         /* obsolete */
#define lpx_set_row_coef      glp_lpx_set_row_coef       /* obsolete */
#define lpx_set_col_coef      glp_lpx_set_col_coef       /* obsolete */
#define lpx_load_mat          glp_lpx_load_mat           /* obsolete */
#define lpx_load_mat3         glp_lpx_load_mat3          /* obsolete */
#define lpx_unmark_all        glp_lpx_unmark_all         /* obsolete */
#define lpx_mark_row          glp_lpx_mark_row           /* obsolete */
#define lpx_mark_col          glp_lpx_mark_col           /* obsolete */
#define lpx_clear_mat         glp_lpx_clear_mat          /* obsolete */
#define lpx_del_items         glp_lpx_del_items          /* obsolete */
...
#define lpx_get_obj_c0        glp_lpx_get_obj_c0         /* obsolete */
#define lpx_get_row_coef      glp_lpx_get_row_coef       /* obsolete */
#define lpx_get_col_coef      glp_lpx_get_col_coef       /* obsolete */
#define lpx_get_row_mark      glp_lpx_get_row_mark       /* obsolete */
#define lpx_get_col_mark      glp_lpx_get_col_mark       /* obsolete */
#define lpx_get_row_info      glp_lpx_get_row_info       /* obsolete */
#define lpx_get_col_info      glp_lpx_get_col_info       /* obsolete */
#define lpx_get_ips_stat      glp_lpx_get_ips_stat       /* obsolete */
#define lpx_get_ips_row       glp_lpx_get_ips_row        /* obsolete */
#define lpx_get_ips_col       glp_lpx_get_ips_col        /* obsolete */
#define lpx_get_ips_obj       glp_lpx_get_ips_obj        /* obsolete */
#define lpx_get_mip_stat      glp_lpx_get_mip_stat       /* obsolete */
#define lpx_get_mip_row       glp_lpx_get_mip_row        /* obsolete */
#define lpx_get_mip_col       glp_lpx_get_mip_col        /* obsolete */
#define lpx_get_mip_obj       glp_lpx_get_mip_obj        /* obsolete */
...
/* remove rows and columns from problem object */
