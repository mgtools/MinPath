...
{     int p;
      ...
      print("+%6d:   ip_obj = %s %s %17s (%d; %d)",
         lpx_get_int_parm(tree->lp, LPX_K_ITCNT), best, rho, glob,
         tree->a_cnt, tree->t_cnt - tree->n_cnt);
      tree->tm_lag = utime();
      return;
}
